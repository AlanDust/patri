    ...
    return(
      <div>
        ...
        <div className="show-page-quote">
          <p className="quote"> "A poet knows he has achieved perfection not when there is nothing left to add, but when there is nothing left to take away. Details make perfection, and perfection is not a detail."</p>
        ...
        <div className="large-12 medium-12 small-12 column">
          ...
          <div className="large-6 medium-12 small-12 column all-animal-tiles">
            {animalTiles}
          </div>
        </div>
      </div>
